...
export default {
  ...
  defringe: '白縁を徹底除去（混色/碎辺）',
  defringeDesc:
    '半透明の背景混色除去と近サンプル碎辺のクリア。下のエッジ収縮・弱いアルファ除去は本スイッチと独立して常に有効です。',
  erodePx: 'エッジ収縮',
  erodePxDesc:
    '不透明輪郭を0〜15px内側へ削り白縁を除去。大きな原画は2〜8推奨。小さいプレビューでは見えにくいので拡大/ダウンロードで確認。大きすぎると輪郭が欠けます。',
  alphaCutoff: '弱いアルファ除去',
  alphaCutoffDesc:
    'この閾値未満のアルファを完全透明にします（常に独立して有効）。大きすぎると輪郭が硬くなります。',
