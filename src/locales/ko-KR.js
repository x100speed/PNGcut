...
export default {
  ...
  defringe: '흰 테두리 제거(혼색/잔여 변)',
  defringeDesc:
    '반투명 배경 혼색 제거와 가장자리 잔여 변 정리. 아래 가장자리 수축·약한 알파 제거는 이 스위치와 무관하게 항상 적용됩니다.',
  erodePx: '가장자리 수축',
  erodePxDesc:
    '불투명 윤곽을 0~15px 안쪽으로 줄여 흰 테두리를 제거합니다. 큰 원본은 2~8 권장. 작은 미리보기에서는 잘 안 보이니 확대/다운로드로 확인하세요.',
  alphaCutoff: '약한 알파 제거',
  alphaCutoffDesc:
    '이 임계값 미만 알파를 완전 투명으로 만듭니다(항상 독립 적용). 너무 크면 가장자리가 딱딱해집니다.',
